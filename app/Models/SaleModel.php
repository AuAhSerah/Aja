...
class SaleModel extends Model
{
    ...
    public function getReport($tgl_awal, $tgl_akhir)
    {
        ...
        // return $this->db->query("SELECT s.sale_id, s.created_at tgl_transaksi, us.id user_id, us.firstname, us.lastname, us.user_name, c.customer_id, c.name name_cust, c.no_customer, SUM(sd.total_price) total FROM sale_detail sd
        // JOIN sale s ON s.sale_id = sd.sale_id 
        // JOIN pengguna us ON us.id = s.user_id 
