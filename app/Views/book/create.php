        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('book/create') ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="mb-3 row">
                        <label for="title" class="col-som-2 col-form-label">Judul</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        <label for="author" class="col-som-2 col-form-label">Penulis</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        <label for="release_year" class="col-som-2 col-form-label">Tahun Terbit</label>
                        <div class="col-sm-5">
                    ...
                    <div class="mb-3 row">
                        <label for="stock" class="col-som-2 col-form-label">Stok</label>
                        <div class="col-sm-3">
                    ...
                    <div class="mb-3 row">
                        <label for="price" class="col-som-2 col-form-label">Harga</label>
                        <div class="col-sm-5">
                    ...
                    <div class="mb-3 row">
                        <label for="discount" class="col-som-2 col-form-label">Diskon</label>
                        <div class="col-sm-5">
                            <div class="col-sm-3">
